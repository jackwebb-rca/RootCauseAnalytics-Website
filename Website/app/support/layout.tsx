...
const faqSchema = {
  ...
  mainEntity: [
    ...
    {
      '@type': 'Question',
      name: 'Does MEDISCAN keep data inside Snowflake?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'MEDISCAN runs as a Snowflake Native App inside your own Snowflake account. Patient data never leaves your environment, and your existing Snowflake security controls, audit logs, and access policies apply to every document processed.',
      },
    },
    {
      '@type': 'Question',
