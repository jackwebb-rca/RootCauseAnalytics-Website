...
const faqs: FaqCategory[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        answer: 'You need an active Snowflake account with a supported edition. MEDISCAN installs as a Snowflake Native App, so your data stays in your existing environment.',
      },
      {
  ...
  },
  {
    ...
    items: [
      {
        question: 'Does MEDISCAN keep data inside Snowflake?',
        answer: 'MEDISCAN runs as a Snowflake Native App inside your own Snowflake account. Patient data never leaves your environment, and your existing Snowflake security controls, audit logs, and access policies apply to every document processed.',
      },
      {
        question: 'What security controls apply?',
        answer: 'MEDISCAN inherits the security controls, audit logging, and access policies in your Snowflake account. It runs inside your environment and does not introduce third-party data processors for document handling.',
      },
      {
