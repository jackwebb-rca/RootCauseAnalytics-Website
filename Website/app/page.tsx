            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
              <div className="animate-on-scroll">
                ...
                <p className="text-slate-600 leading-relaxed mb-6">
                  MEDISCAN is architected as a Snowflake Native App so patient data never leaves your Snowflake environment. The app inherits the security, compliance, and audit capabilities of your own Snowflake account.
                </p>
                <ul className="flex flex-col gap-3">
                  {[
                    ...
                    'Runs on Snowflake infrastructure, which is HIPAA-eligible and SOC 2 Type II certified at the platform level',
                  ].map((item) => (
