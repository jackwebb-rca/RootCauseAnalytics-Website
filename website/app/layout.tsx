...
export const metadata: Metadata = {
  ...
  description: 'MEDISCAN transforms healthcare document processing with AI-powered OCR and NLP on Snowflake. 90-99% accuracy, $0.10 per page, 10 Minute Deployment Time. HIPAA Compliant & SOC 2 Type II certified.',
  generator: 'v0.app',
