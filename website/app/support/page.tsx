  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        answer: 'MEDISCAN achieves 99% accuracy on clean, high-quality printed documents. Overall accuracy ranges from 90-99% depending on document quality and type. Handwritten notes and low-resolution scans may achieve lower extraction rates. Contact our team for document-specific benchmarks relevant to your use case.',
      },
      {
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              ...
              >
                ...
                <div>
                  ...
                  <div className="text-xs text-slate-500 mt-0.5">support@mediscan.health</div>
                </div>
              </a>
