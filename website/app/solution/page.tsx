...
const comparisonRows = [
  {
    ...
    traditional: '$4.20 - $8.50 per page',
    highlight: true,
  },
  {
    feature: 'Extraction Accuracy',
    mediscan: '90-99% (clean documents)',
    traditional: '70-85%',
    highlight: true,
  },
  {
...
const architectureSteps = [
  ...
  },
  {
    ...
    description: 'MEDISCAN\'s OCR engine and clinical NLP models run as Snowflake Native App functions, processing pages at 90-99% accuracy on clean, high-quality printed documents.',
  },
  {
    icon: Database,
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              {[
                ...
                { value: '90-99%', label: 'Extraction accuracy', green: true },
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
                <div>
                  ...
                  <p className="text-slate-700 leading-relaxed mb-4">
                    MEDISCAN achieves 99% accuracy on clean, high-quality printed documents. Accuracy ranges from 90-99% depending on document quality and type, in line with industry benchmarks for AI-based OCR systems.
                  </p>
                ...
                <div className="grid grid-cols-2 gap-4">
                  {[
                    ...
                    { label: 'Mixed Quality', range: '90-99%', color: '#0D9488' },
