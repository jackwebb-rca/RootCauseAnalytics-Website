...
const supportLinks = [
  ...
  { label: 'Support Email', href: 'mailto:support@mediscan.health', external: true },
]
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="py-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-2">
            <Link href="/" className="flex items-center gap-2 mb-4" aria-label="MEDISCAN home">
              <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-[#0D9488] to-[#1E3A8A] flex items-center justify-center">
                <span className="text-white font-bold text-sm">M</span>
              </div>
              <span className="font-bold text-lg text-white tracking-tight">MEDISCAN</span>
            </Link>
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="flex items-center gap-2 text-sm text-slate-400">
                <Mail size={14} className="text-[#0D9488] shrink-0" />
                <a
                  href="mailto:support@mediscan.health"
                  className="hover:text-[#0D9488] transition-colors"
                >
                  support@mediscan.health
                </a>
              </div>
            </div>
          </div>
