...
const radarData = [
  ...
  { subject: 'Security', MEDISCAN: 98, Traditional: 60 },
...
const comparisonRows = [
  ...
  },
  {
    ...
    mediscan: 'Inside your Snowflake account',
    traditional: 'Varies',
    highlight: false,
  },
  {
    feature: 'Volume Discounts',
    mediscan: 'Available for high-volume',
...
const pricingTiers = [
  {
    ...
    price: '$0.10',
    unit: 'per page',
    description: 'For healthcare organisations getting started with document digitisation.',
    features: [
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-start">
              ...
              <div className="animate-on-scroll overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
                <div className="grid grid-cols-3 bg-[#1E3A8A] text-white text-sm font-semibold">
                  ...
                  <div className="p-4 text-white text-center border-x border-white/20">
                    MEDISCAN
                  </div>
                ...
                {comparisonRows.map((row, i) => (
                  ...
                  >
                    <div className="p-4 font-medium text-slate-700 text-center">{row.feature}</div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
                ...
                <div className="grid grid-cols-2 gap-4">
                  {[
                    ...
                    { label: 'Clinical NLP Entities', range: '98%+', color: '#0D9488' },
              ...
              <div className="animate-on-scroll">
                <div className="bg-white rounded-2xl border border-slate-200 p-6 shadow-sm">
                  ...
                  <div className="flex flex-col gap-4">
                    {[
                      { type: 'Discharge Summaries', threshold: '97.5%', auto: '99.0%', color: '#1E3A8A' },
                      { type: 'Referral Letters',    threshold: '97.5%', auto: '98.5%', color: '#0D9488' },
                      { type: 'Pathology Reports',   threshold: '97.5%', auto: '99.5%', color: '#0D9488' },
                      { type: 'Admin Forms',          threshold: '97.5%', auto: '97.5%', color: '#10B981' },
              ...
              <div className="animate-on-scroll order-1 lg:order-2">
                ...
                <div className="flex flex-col gap-3">
                  {[
                    ...
                    'Exportable reports for internal audit and review purposes',
                  ].map((point) => (
                    <div key={point} className="flex items-start gap-3">
                      <CheckCircle size={16} className="text-[#0D9488] mt-0.5 shrink-0" />
                      <span className="text-slate-700 text-sm">{point}</span>
        ...
        <section className="py-20 bg-slate-50" aria-label="Pricing">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center max-w-2xl mx-auto mb-14 animate-on-scroll">
              ...
              <p className="text-slate-600 leading-relaxed">
                $0.10 per page processed. No setup fees, no hidden costs, no infrastructure to manage. Volume discounts available for high-volume organisations.
              </p>
            </div>
            ...
            <p className="text-center text-sm text-slate-500 mt-8">
              All plans include zero data movement architecture, Snowflake-native processing, and document handling within your Snowflake account.
            </p>
          </div>
        </section>
