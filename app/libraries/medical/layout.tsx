...
export const metadata: Metadata = {
  ...
  description: '30+ document types across hospital, ED, GP clinic, pathology, imaging and specialist correspondence. Ground truth, bounding boxes and scanned variants shipped with every document.',
  alternates: {
  ...
  openGraph: {
    type: 'website',
    title: 'RCA Medical Library - Synthetic Australian medical training documents',
    description: '30+ document types with ground truth and bounding boxes. Built for document AI evaluation and training.',
